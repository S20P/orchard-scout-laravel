...
class CropLocationController extends Controller
{
    ...
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            return Datatables::of($data)
                ...
                ->addColumn('action', function (CropLocation $data) {
                    ...
                    $edit_button = '';
                    $delete_button = '';
                    if ($user_data->hasPermission('crop-locations', 'update')) {
                        $edit_button .= '<a href="' . route('crop-locations.edit', $data->id) . '" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
        ...
        return view('crop-locations.index');
    }
    /**
    ...
    public function create(Request $request)
    {
        ...
        return view('crop-locations.create', compact('Customers'));
    }
    /**
