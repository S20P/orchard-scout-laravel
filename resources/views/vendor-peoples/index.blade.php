@extends('layouts.app')
@section('breadcrumb')
<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{__('Vendor Peoples')}}</h1>
...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('Vendor Peoples')}}</li>
</ul>
@endsection
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-customer-table-filter="search" name="data_tbl_search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="{{__('Search Vendor Peoples')}}" />
                    </div>
                </div>
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Menu 1-->
                        <!--end::Filter-->
                    @permission('vendor-peoples','create')
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="{{route('vendor-peoples.create',$vendor_id)}}" class="btn btn-primary">Add</a>
                    </div>
                    @endpermission
                </div>
                </div>
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="dataTableList">
                    <thead>
                        <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                            ...
                            <th class="min-w-90px">{{__('Vendor')}}</th>
                            <th class="min-w-125px">{{__('People')}}</th>
                            <th class="min-w-125px">{{__('People Role')}}</th>
...
<script>
    var listIndex = "{{ route('vendor-peoples.index',$vendor_id) }}"
</script>
<script src="{{asset('js/module/vendor-peoples.js')}}"></script>
@endsection