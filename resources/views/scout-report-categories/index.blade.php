...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('Scout Report Categories')}}</li>
</ul>
@endsection
        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-customer-table-filter="search" name="data_tbl_search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="Search Scout Report Categories" />
                    </div>
                </div>
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="{{route('scout-report-categories.create')}}" class="btn btn-primary">Add</a>
                    </div>
                    @endpermission
                </div>
                </div>
...
<script>
    var listIndex = "{{ route('scout-report-categories.index') }}"
</script>
<script src="{{asset('js/module/scout-report-categories.js')}}"></script>
@endsection