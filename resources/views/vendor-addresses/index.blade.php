...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('Vendor Addresses')}}</li>
</ul>
@endsection
            ...
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-customer-table-filter="search" name="data_tbl_search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="{{__('Search Vendor Address')}}" />
                    </div>
                </div>
                <div class="card-toolbar">
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--end::Menu 1-->
                        <!--end::Filter-->
                    @permission('vendor-addresses','create')
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="{{route('vendor-addresses.create',$vendor_id)}}" class="btn btn-primary">Add</a>
                    </div>
                    @endpermission
                </div>
                </div>
...
<script>
    var listIndex = "{{ route('vendor-addresses.index',$vendor_id) }}"
</script>
<script src="{{asset('js/module/vendor-addresses.js')}}"></script>
@endsection