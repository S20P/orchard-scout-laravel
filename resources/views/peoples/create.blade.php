    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="add_frm" name='add_frm' class="form" method="post" action="{{ route('peoples.store') }}">
                    @csrf
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="suffix"
                                    ...
                                    placeholder="{{__('Suffix')}}" value='{{old('suffix')}}'/>
                                @error('suffix')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="nickname"
                                    ...
                                    placeholder="{{__('Nickname')}}" value='{{old('nickname')}}'/>
                                @error('nickname')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="maiden_name"
                                    ...
                                    placeholder="{{__('Maiden Name')}}" value='{{old('maiden_name')}}'/>
                                @error('maiden_name')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input name="date_of_birth"
                                    ...
                                    placeholder="{{__('Date Of Birth')}}" id='date_of_birth' value='{{old("date_of_birth")}}'/>
                                @error('date_of_birth')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
