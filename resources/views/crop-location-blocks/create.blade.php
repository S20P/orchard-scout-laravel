        ...
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="add_frm" name='add_frm' class="form" method="post"
                    action="{{ route('crop-location-blocks.store') }}">
                    @csrf
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select
                                    ...
                                    <option value='{{$CropLocation->id}}' @if (old('crop_location_id')==$CropLocation->id)
                                        {{'selected'}}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="acres"
                                    ...
                                    placeholder="{{__('Acres')}}" value='{{old('acres')}}' />
                                @error('acres')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="year_planted"
                                    ...
                                    placeholder="{{__('Year Planted')}}" value='{{old('year_planted')}}' />
                                @error('year_planted')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="plant_feet_spacing_in_rows"
                                    ...
                                    placeholder="{{__('Plant Feet Spacing In Rows')}}" value='{{old('plant_feet_spacing_in_rows')}}' />
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="plant_feet_between_rows"
                                    ...
                                    placeholder="{{__('Plant Feet Between Rows')}}" value='{{old('plant_feet_between_rows')}}' />
