    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="add_frm" name='add_frm' class="form" method="post" action="{{ route('crop-commodity-varieties.store') }}">
                    @csrf
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <select
                                    ...
                                    id='crop_commodity_type_id' name="crop_commodity_id">
                                    <option value=''>{{__('Select crop commodity')}}</option>
