...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('Crop Locations')}}</li>
</ul>
@endsection
        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                <div class="card-title">
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" data-kt-customer-table-filter="search" name="data_tbl_search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="{{__('Search Crop Locations')}}" />
                    </div>
                </div>
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="{{route('crop-locations.create')}}" class="btn btn-primary">Add</a>
                    </div>
                    @endpermission
                </div>
            </div>
...
<script>
    var listIndex = "{{ route('crop-locations.index') }}"
</script>
<script src="{{asset('js/module/crop-locations.js')}}"></script>
@endsection