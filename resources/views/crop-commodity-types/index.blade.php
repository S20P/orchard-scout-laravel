...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-dark">{{__('Crop Commodity Types')}}</li>
</ul>
@endsection
        ...
        <div class="card">
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        <a href="{{route('crop-commodity-types.create')}}" class="btn btn-primary">Add</a>
                    </div>
                    @endpermission
                </div>
                </div>
...
<script>
    var listIndex = "{{ route('crop-commodity-types.index') }}"
</script>
<script src="{{asset('js/module/crop-commodity-types.js')}}"></script>
@endsection