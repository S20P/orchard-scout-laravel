        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card mb-5 mb-xl-10">
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <form id="add_item_form" class="form" method="post" action="{{route('questions.update',$questionItem->id)}}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="scout_report_category_id" id="location_id" aria-label="Select a Location" data-control="select2" data-placeholder="Select a Scout Report Category..." class="form-select form-select-solid form-select-lg fw-bold">
                                        ...
                                        <option value="{{ $ScoutReportCategory->id }}"  @if($ScoutReportCategory->id ===
                                            $questionItem->scout_report_category_id) {{'selected'}} @endif >{{ $ScoutReportCategory->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="position"
                                        ...
                                        placeholder="Item Position" value="{{$questionItem->position}}" />
                                    @error('position')
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <select name="status" aria-label="Select a Status" data-control="select2"
                                        ...
                                        <option value="true" @if($questionItem->status === true) {{'selected'}}
                                            @endif>Active</option>
                                        <option value="false" @if($questionItem->status === false) {{'selected'}}
                              ...
                              <div id="kt_docs_repeater_advanced">
                                <div class="form-group">
                                    <div data-repeater-list="kt_docs_repeater_advanced">
                                        @if($questionItem->getItemOptionAttributes!=null && !empty($questionItem->getItemOptionAttributes) && count($questionItem->getItemOptionAttributes) > 0) 
                                        @foreach($questionItem->getItemOptionAttributes as $attr)
                                        <div data-repeater-item class='option-item-wrap'>
                                            ...
                                            <div class="form-group row mb-5">
                                                ...
                                                <div class="col-lg-6">
                                                    <input type="text" name="label" value='{{$attr->label}}' class="form-control form-control-lg form-control-solid text-required-box" placeholder="Input Label" />
                                                </div>
                                                    <div class="col-lg-2">
