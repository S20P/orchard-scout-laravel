    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="add_frm" name='add_frm' class="form" method="post" action="{{ route('crop-commodities.store') }}">
                    @csrf
                            ...
                            <div class="col-lg-8 fv-row">
                                <select
                                    ...
                                    @foreach ($CropCommodityTypes as $CropCommodityType)
                                        <option value='{{$CropCommodityType->id}}' @if (old('crop_commodity_type_id')==$CropCommodityType->id)
                                            {{'selected'}}
