@extends('layouts.app')
@section('breadcrumb')
<h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">{{__('Vendor Phones')}}</h1>
...
<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
    ...
    <li class="breadcrumb-item text-muted">
        <a href="{{route('vendor-phones.index',$vendor_id)}}" class="text-muted text-hover-primary"> {{__('Vendor Phones')}}</a>
    </li>
    <li class="breadcrumb-item">
        <span class="bullet bg-gray-300 w-5px h-2px"></span>
    </li>
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card mb-5 mb-xl-10">
            <div id="kt_account_settings_profile_details" class="collapse show">
                <form id="add_frm" name='add_frm' class="form" method="post" action="{{ route('vendor-phones.store') }}">
                    @csrf
                            ...
                            <div class="col-lg-8 fv-row">
                                <select
                                    ...
                                    @foreach ($PhoneTypes as $PhoneType)
                                        <option value='{{$PhoneType->id}}' @if (old('phone_type_id')==$PhoneType->id)
                                            {{'selected'}}
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="area_code"
                                    ...
                                    placeholder="{{__('Area Code')}}" value='{{old('area_code')}}'/>
                                @error('area_code')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="prefix"
                                    ...
                                    placeholder="{{__('Prefix')}}" value='{{old('prefix')}}'/>
                                @error('prefix')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="row mb-6">
                            ...
                            <div class="col-lg-8 fv-row">
                                <input type="text" name="extension"
                                    ...
                                    placeholder="{{__('Extension')}}" value='{{old('extension')}}'/>
                                @error('extension')
                                <span class="invalid-feedback" role="alert">
                                    {{ $message }}
                                </span>
...
<script src="{{url('js/module/vendor-phones.js')}}"></script>
@endsection